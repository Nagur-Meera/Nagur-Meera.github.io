...
const getApiUrl = () => {
  ...
  // In production, use the environment variable or fallback to Railway URL
  const apiUrl = import.meta.env.VITE_API_URL || 'https://verifact-production.up.railway.app';
