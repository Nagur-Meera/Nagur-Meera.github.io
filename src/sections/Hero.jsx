        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <div className="text-2xl md:text-3xl lg:text-4xl text-gray-300 mb-4">
              <span className="text-primary-400">Full Stack</span> Developer
            </div>
            <div className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Passionate Computer Science student crafting innovative solutions with 
              modern technologies. Building the future, one line of code at a time.
            </div>
          </motion.div>
